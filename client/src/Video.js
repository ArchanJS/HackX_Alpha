		...
		return (
			<div>
				{this.state.askForUsername === true ?
					<div>
						<div style={{background: "rgb(158, 255, 247)", width: "30%", height: "auto", padding: "20px", minWidth: "400px",
								textAlign: "center", margin: "auto", marginTop: "50px", justifyContent: "center"}}>
					...
					:
					<div>
						<div className="btn-down" style={{ backgroundColor: "rgb(158, 255, 247)", color: "whitesmoke", textAlign: "center" }}>
						...
						<div className="container">
							<div style={{ paddingTop: "20px" }}>
								<Input style={{color:"aqua"}} value={window.location.href} disable="true"></Input>
